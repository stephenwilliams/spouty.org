...
<div class="container">
		...
		<div class="row">
				...
				<p> First you need to register with Spouty. This needs to be done in a private message. It is suggested that your account name be your primary nick.<br />
						<code>.register Account_Name password</code> </p>
				<p>If you want to add another hostmask to your account execute the following command. This also has to be done in private message.<br />
						<code>.addhostname Account_Name password</code> </p>
				<p> If you want to temporarily authenticate, you need to use the authenticate command. This command needs to be used in a private message.<br />
						<code>.authenticate Account_Name password</code> </p>
				<p>Any questions concerning Spouty's account system can be answered by the Bot Admins in ##Spouty. <br />
						<span class="label label-info">Remember!</span>&nbsp;&nbsp;Passwords are hashed with SHA-1 and not logged in Spouty's IRC logs! </p>
			</div>
			</div>
	</section>
		<section id="factoids">
